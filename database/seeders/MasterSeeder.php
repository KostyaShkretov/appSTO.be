...
class MasterSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Master::create([
            ...
            'about' => 'Специалист по ходовой части. По звуку определит проблему точнее, чем сканнер. В прошлом музыкант'
        ]);
        Master::create([
        ...
        Master::create([
            ...
            'about' => 'Отличный автоэлектрик с нестандартным подходом. Разбирается во всем так как будто играет в квест. Один раз клиент пожаловался что машина начала разговаривать через магнитолу'
        ]);
        Master::create([
